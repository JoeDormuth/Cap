...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class PermissionCategoryRepository : BaseRepository<PermissionCategory>, IPermissionCategoryRepository {
    	
    	public PermissionCategoryRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
