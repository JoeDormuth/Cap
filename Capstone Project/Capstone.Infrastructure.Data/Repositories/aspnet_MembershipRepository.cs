...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class aspnet_MembershipRepository : BaseRepository<aspnet_Membership>, Iaspnet_MembershipRepository {
    	
    	public aspnet_MembershipRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
