...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class aspnet_RolesRepository : BaseRepository<aspnet_Roles>, Iaspnet_RolesRepository {
    	
    	public aspnet_RolesRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
