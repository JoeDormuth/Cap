...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class ReleaseBacklogRepository : BaseRepository<ReleaseBacklog>, IReleaseBacklogRepository {
    	
    	public ReleaseBacklogRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
