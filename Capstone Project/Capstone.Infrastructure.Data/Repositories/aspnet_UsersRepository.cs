...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class aspnet_UsersRepository : BaseRepository<aspnet_Users>, Iaspnet_UsersRepository {
    	
    	public aspnet_UsersRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
