...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class Features_BugsRepository : BaseRepository<Features_Bugs>, IFeatures_BugsRepository {
    	
    	public Features_BugsRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
