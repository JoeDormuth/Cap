...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class ProjectBacklogRepository : BaseRepository<ProjectBacklog>, IProjectBacklogRepository {
    	
    	public ProjectBacklogRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
