...
namespace Capstone.Infrastructure.Data.Repositories {
    public partial class aspnet_ProfileRepository : BaseRepository<aspnet_Profile>, Iaspnet_ProfileRepository {
    	
    	public aspnet_ProfileRepository(IUnitOfWork _uow) : base(_uow) {
    	}
    }
}
